    ...
    flex justify-center items-center flex-col'>
        ...
        <h1 className='text-white text-[30px] text-center mb-[40px]'>Select Your {" "}<span className='text-blue-400'>Assistant Image</span></h1>
            ...
            <div className='w-full max-w-[900px] flex justify-center items-center flex-wrap gap-[20px]'>
                ...
                <div className={`w-[65px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#030326]  border-2 border-[#080882] rounded-2xl overflow-hidden
                     hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex justify-center
                     items-center   ${selectedImage === "input" ? "border-4 border-white" : null}`} onClick={()=>{
            ...
            {selectedImage &&   <button className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold
             bg-white rounded-full text-[19px] cursor-pointer' onClick={()=>navigate('/customize2')}>Next</button>}
