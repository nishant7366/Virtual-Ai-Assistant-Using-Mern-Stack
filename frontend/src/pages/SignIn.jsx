    ...
    return (
        <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
            <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex
                             flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
               ...
               required onChange={(e)=>setPassword(e.target.value)}  value={password}/>
                ...
                {err.length>0 && <p className='text-red-500 text-xl'>
                  ...
                  <button type='submit' className='w-[150px] h-[60px] mt-5 rounded-full bg-[#00000000] backdrop-blur text-xl text-white' disabled={loading}>{ loading?"...loading":"SignIn"}</button>
                <p className='text-xl  text-white'>want to create a new account {" "}<span className='text-blue-400 cursor-pointer'
